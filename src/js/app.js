/* ==========================================================================
   Google AI Studio - TaskFlow - App Bootstrapper & Event Handlers
   ========================================================================== */

import { loadTodosState, addTodo, updateTodo, undoDeleteTodo, clearCompletedTodos } from './taskManager.js';
import { 
  initDarkMode, 
  toggleDarkMode, 
  setSearchQuery, 
